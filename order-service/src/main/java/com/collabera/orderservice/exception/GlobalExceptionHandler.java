...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler
	public ResponseEntity<Object> handler(OrderNotFoundException orderNotFoundException){
		return new ResponseEntity<Object>(ResponseEntity.badRequest().body(orderNotFoundException.getMessage()), HttpStatus.BAD_REQUEST);
	}
